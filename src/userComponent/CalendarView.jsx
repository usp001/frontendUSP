...
export default function CalendarView({ onDataChange }) {
  ...
  return (
    <Paper sx={{ height: "100%", width: "100%" }}>
      ...
      <FullCalendar
        ...
        select={(info) => {
          // Open the modal on date/time click
        ...
        eventClick={(info) => alert(`Event: ${info.event.title}`)} // Example of an event click
        style={{ width: "80%", height: "400px", margin: "0 auto" }} // Adjust width and height
      />
      ...
      >
        <Box sx={modalStyle}>
          <h2 id="add-event-modal-title">Add New Event</h2>
