...
import PositionedSnackbar from "../component/SnackbarCustom";
...
export default function DataTable({refreshKey}) {
  ...
  const fetchAr = async () => {
    try {
        ...
        console.log("department here");
    
        console.log(userDepartment);
    
        setDepartment([userDepartment])
      const response = await axios.post(
        "https://backend-production-fc3a.up.railway.app/api/ar/reports-user",
      ...
      if (result.message === "fetch successfully") {
...
//     try {
//       const response = await axios.post(
//         "https://backend-production-fc3a.up.railway.app/api/ar/approved",
//         { id: row.id },
//         {
//           headers: {
...
//     try {
//       const response = await axios.post(
//         "https://backend-production-fc3a.up.railway.app/api/ar/reject",
//         { id: row.id },
//         {
//           headers: {
//             "Content-type": "application/json",
